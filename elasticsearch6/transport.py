...
def get_host_info(node_info, host):
    ...
    information needs to be provided for the :class:`~elasticsearch6.Connection`
...
class Transport(object):
    ...
    def __init__(self, hosts, connection_class=Urllib3HttpConnection,
        ...
        :arg connection_class: subclass of :class:`~elasticsearch6.Connection` to use
        :arg connection_pool_class: subclass of :class:`~elasticsearch6.ConnectionPool` to use
    ...
    def add_connection(self, host):
        """
        Create a new :class:`~elasticsearch6.Connection` instance and add it to the pool.
    ...
    def get_connection(self):
        """
        Retreive a :class:`~elasticsearch6.Connection` instance from the
        :class:`~elasticsearch6.ConnectionPool` instance.
        """
    ...
    def mark_dead(self, connection):
        ...
        :arg connection: instance of :class:`~elasticsearch6.Connection` that failed
        """
    ...
    def perform_request(self, method, url, headers=None, params=None, body=None):
        ...
        :arg headers: dictionary of headers, will be handed over to the
            underlying :class:`~elasticsearch6.Connection` class
        :arg params: dictionary of query parameters, will be handed over to the
            underlying :class:`~elasticsearch6.Connection` class for serialization
